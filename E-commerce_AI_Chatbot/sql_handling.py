...
def data_comprehensive(question, context):
...
def sql_chain_with_history(question: str, session_id: str = "default"):
    ...
    answer = data_comprehensive(question, context)
...
if __name__ == "__main__":
      sql_query = generate_sql_query("Show me Nike shoes under Rs.5000")
      answer = sql_chain_with_history("List top 5 puma shoes products?")
      print(sql_query)
