...
def ask(query: str, session_id: str) -> Optional[str]:
    """Route query to appropriate handler."""
    try:
        route = router(query).name
        if route == "faq":
            return faq_chain_with_history(query, session_id)
        elif route == "sql":
            return sql_chain_with_history(query, session_id)
        elif route == "small_talk":
            return small_talk_chain_with_history(query, session_id)
        else:
