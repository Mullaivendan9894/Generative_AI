...
#       sql_query = generate_sql_query("List top 5 puma shoes products?",GROQ_API_KEY, GROQ_MODEL)
#       answer = sql_chain_with_history("List top 5 puma shoes products?",GROQ_API_KEY, GROQ_MODEL)
#       print(sql_query)
#       print(answer)
